 ...
 *   minLotSize   - optional per-axis floor for layouts that cannot safely shrink
...
export const LANDMARKS = {
  ...
  hospital: {
    ...
    category: 'community', zones: ['civic', 'medium'], footprint: [16, 16], minLotSize: [16, 16], lot: 'lot-hospital',
  ...
  busStation: {
    ...
    category: 'transport', zones: ['transport', 'medium', 'civic'], footprint: [20, 16], minLotSize: [18, 12],
  ...
  gasStation: {
    ...
    category: 'transport', zones: ['small', 'medium', 'transport'], footprint: [18, 14], minLotSize: [14, 12],
